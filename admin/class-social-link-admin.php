...
class Social_link_Admin {
		...
		public function enqueue_styles() {
			...
			wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/social-link-admin.css', array(), $this->version, 'all' );
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/social-link-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function page_init()
	{
			...
			add_settings_field(
					'tumblr', // ID
					'Tumblr', // Title
					array( $this, 'tumblr_callback' ), // Callback
					'social-link-admin', // Page
					'setting_section_id' // Section
			);
			...
			add_settings_field(
					'skype', // ID
					'Skype', // Title
					array( $this, 'skype_callback' ), // Callback
					'social-link-admin', // Page
					'setting_section_id' // Section
			);
			...
			add_settings_field(
					'soundcloud', // ID
					'Soundcloud', // Title
					array( $this, 'soundcloud_callback' ), // Callback
					'social-link-admin', // Page
					'setting_section_id' // Section
			);
